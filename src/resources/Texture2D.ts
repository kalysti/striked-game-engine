...
export class Texture2D extends EngineObject {
    ...
    constructor(device: LogicalDevice, physicalDevice: VkPhysicalDevice, cmdPool: VkCommandPool) {
        super();
        this.device = device;
    ...
    setNewLayout(imageLayout: VkImageLayout, subresourceRange: VkImageSubresourceRange | null = null) {
        ...
        cmdBufferAllocInfo.commandPool = this.cmdPool;
