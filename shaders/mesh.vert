...
void main() {
  vec4 vertexPosition = ubo.projection * ubo.view * uboModel.model * vec4(aVertexPosition, 1.0);
  vec4 worldPosition = uboModel.model * vec4(aVertexPosition, 1.0);
  vec3 surfaceNormal = mat3(uboModel.model) * aVertexNormal;
