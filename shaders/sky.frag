...
layout (location = 3) in float cirrus;
layout (location = 4) in float cumulus;
layout (location = 5) in float Br;
layout (location = 6) in float Bm;
layout (location = 7) in float g;
layout (location = 8) in vec3 nitrogen;
...
//onst vec3 nitrogen = vec3(0.650, 0.570, 0.475);
